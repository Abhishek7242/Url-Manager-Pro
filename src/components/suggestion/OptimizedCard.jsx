...
const OptimizedCard = () => {
  return (
    <div className="relative flex items-center justify-center py-10">
      ...
      <div
        className="relative w-[420px] overflow-hidden rounded-3xl px-8 py-10 text-center backdrop-blur-md"
        style={{
          background:
      ...
      >
        ...
        >
          ...
          <motion.div
            ...
            className="flex items-center justify-center h-20 w-20 rounded-full border border-white/10 bg-gradient-to-br from-green-400/10 to-blue-500/10 shadow-[0_0_25px_rgba(59,130,246,0.25)]"
          >
          ...
          <p className="text-sm text-white/60 max-w-[85%] leading-relaxed">
            Your URL collection is{" "}
            <span className="text-green-400 font-medium">well-organized</span>.
            <br />
          ...
          <motion.div
            ...
            className="mt-4 h-[1px] w-32 rounded-full bg-gradient-to-r from-transparent via-green-400/50 to-transparent"
          />
        </motion.div>
      </div>
    </div>
